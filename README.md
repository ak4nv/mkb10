...
Для быстрой установки проекта используйте утилиту **[uv][1]**, доступную как из официальных репозиториев большинства популярных дистрибутивов, так и через [скрипт установки][2] на сайте разработчика.
